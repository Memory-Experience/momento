...
async def dataset_configurations() -> AsyncIterator[
    ...
    timeline_qa_sparse = LifelogQADataset.generate(category=0)
    ...
    timeline_qa_medium = LifelogQADataset.generate(category=1)
    ...
    timeline_qa_dense = LifelogQADataset.generate(category=2)
